...
dE3,deltaE3 = DeltaE(G3,G3_errors,N_cf) #energy gap


fig = plt.figure()
l1 = plt.errorbar(t,dE3, yerr= deltaE3, ecolor = 'r', capsize=5, label=r'$\Delta E (t)$', marker = '.', linestyle = 'none') #numerical value
